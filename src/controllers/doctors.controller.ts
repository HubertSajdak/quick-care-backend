...
export const getAllDoctors = async (req: Request, res: Response) => {
	...
	// 		localField: "DoctorSpecialization.specializationId",
	// 		foreignField: "DoctorSpecialization._id",
	// 		as: "DoctorSpecialization.Specialization",
	// 	},
	// },

	// .toArray(doctors => {
	// 	if (doctors && querySpecializations) {
	// 		return doctors.filter(doctor =>
	// 			doctor.DoctorSpecialization?.some(spec => selectedSpecsArr.includes(`${spec.specializationId}`))
	// 		);
	// 	} else {
	// 		return doctors;
	// 	}
	// })
	// if (doctors && querySpecializations) {
	// 	console.log(selectedSpecsArr);
	// 	console.log(
	// 		doctors.forEach(doc =>
	// 			console.log(doc.DoctorSpecialization?.forEach(el => console.log(`${el.specializationId}`)))
	// 		)
	// 	);
